...
<body>
    <div id='parent'>
       <center> <h2>Your Laundry Cleaning </h2></center>
        ...
        <?php
        $id = $_SESSION["user_id"];
        $res = mysqli_query($conn, "SELECT * FROM laundryrequest WHERE ID='$id' AND Status='pending'");
        ...
        ?>       
            ...
            $res1 = mysqli_query($conn, "SELECT * FROM laundryrequest WHERE ID='$id' AND Status='pending'");
