...
<body>
    <div id='parent'>
        <?php
        $id = $_SESSION["user_id"];
        $res = mysqli_query($conn, "SELECT * FROM laundryrequest WHERE ID='$id' AND Status='finished'");
        ...
        ?>
            ...
            $res1 = mysqli_query($conn, "SELECT * FROM laundryrequest WHERE ID='$id' AND Status='finished'");
